...
ThemeData light = ThemeData(
    fontFamily: '',
    primaryColor: const Color(0xFF6359e7),
    ...
    textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(foregroundColor: const Color(0xFF6359e7))),
